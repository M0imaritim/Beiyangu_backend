...
class RequestDetailSerializer(RequestSerializer):
    ...
    category_details = RequestCategorySerializer(source='category', read_only=True)
    accepted_bid_id = serializers.IntegerField(source='accepted_bid.id', read_only=True)
